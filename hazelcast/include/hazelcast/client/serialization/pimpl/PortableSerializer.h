            ...
            namespace pimpl {
                ...
                public:
                    ...
                    std::unique_ptr<T> read(ObjectDataInput &in, int32_t factoryId, int32_t classId) {
                        ...
                        std::unique_ptr<Portable> object = read(in, std::move(portableInstance), factoryId, classId);
                ...
                private:
                    ...
                    read(ObjectDataInput &in, std::unique_ptr<Portable> portable, int32_t factoryId, int32_t classId);
                };
