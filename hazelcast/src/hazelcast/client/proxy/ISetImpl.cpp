    ...
    namespace client {
        namespace proxy {
            ...
            int ISetImpl::size() {
                ...
                return invokeAndGetResult<int, protocol::codec::SetSizeCodec::ResponseParameters>(std::move(request), partitionId);
            }

            bool ISetImpl::isEmpty() {
                std::unique_ptr<protocol::ClientMessage> request = protocol::codec::SetIsEmptyCodec::encodeRequest(getName());

                return invokeAndGetResult<bool, protocol::codec::SetIsEmptyCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::contains(const serialization::pimpl::Data& element) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetContainsCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            std::vector<serialization::pimpl::Data>  ISetImpl::toArrayData() {
                ...
                return invokeAndGetResult<std::vector<serialization::pimpl::Data>, protocol::codec::SetGetAllCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::add(const serialization::pimpl::Data& element) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetAddCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::remove(const serialization::pimpl::Data& element) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetRemoveCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::containsAll(const std::vector<serialization::pimpl::Data>& elements) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetContainsAllCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::addAll(const std::vector<serialization::pimpl::Data>& elements) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetAddAllCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::removeAll(const std::vector<serialization::pimpl::Data>& elements) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetCompareAndRemoveAllCodec::ResponseParameters>(std::move(request), partitionId);
            }
            ...
            bool ISetImpl::retainAll(const std::vector<serialization::pimpl::Data>& elements) {
                ...
                return invokeAndGetResult<bool, protocol::codec::SetCompareAndRetainAllCodec::ResponseParameters>(std::move(request), partitionId);
            }
