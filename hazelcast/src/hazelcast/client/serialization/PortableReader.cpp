    ...
    namespace client {
        namespace serialization {
            ...
            : isDefaultReader(isDefaultReader) {
                if (isDefaultReader) {
                    defaultPortableReader = std::make_unique<pimpl::DefaultPortableReader>(context, input, cd);
                } else {
                    morphingPortableReader = std::make_unique<pimpl::MorphingPortableReader>(context, input, cd);
                }
            }
